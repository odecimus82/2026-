    ...
    <div className="autumn-card rounded-[2.5rem] p-6 md:p-10 space-y-6 overflow-hidden animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-orange-100 pb-4 gap-4">
        <div>
          ...
          <p className="text-sm text-zinc-500 font-medium">查看所有已提交的报名信息</p>
        </div>
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-10">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-orange-100">
          ...
          <nav className="flex items-center gap-1 md:gap-3">
            {[
              ...
              <button 
                ...
                className={`px-3 md:px-5 py-2 text-xs md:text-sm font-black uppercase transition-all rounded-full ${
                  activeTab === tab.id 
